...
(function ($) {
    ...
    BootstrapPaginator.prototype = {
        ...
        render: function () {
            ...
            this.$element.append('<span class="page-skip">共'+this.totalPages+'页，到第<input type="text" style="padding-top: 0px; padding-bottom: 0px;"  class="page-num" id="page-num">页<button type="button" style="height: 28px;" class="btn_key page-submit" name="page_submit" id="page_submit">确定</button></span>');
            var $this=this;
