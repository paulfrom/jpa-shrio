...
(function(window,document,undefined){
    ...
    var setUpBeaconId = function(){
        ...
        beaconMethod = {
            uvId:'up_beacon_id',//
            memId:'up_dw_track'    ,
            beaconUrl:'127.0.0.1:8083/inpage.html',//记录访问日志的url
            errorUrl:'127.0.0.1:8083/error.html',//记录错误日志的url
            clickUrl:'127.0.0.1:8083/click.html',//记录click日志的url
            ...
            sendRequest:function(url,params){// 日志发送方法
                ...
                try{
                    ...
                    var tmpUrlParam = 'time=' + currDate.getTime();
